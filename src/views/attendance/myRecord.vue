<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          <el-button type="primary" icon="plus" @click="showCreate" v-if="hasPerm('attendance:add')">添加
          </el-button>
        </el-form-item>
      </el-form>
    </div>
        ...
        <el-row type="flex">
          <el-col :span="10">
            <el-form-item label="理由：" :label-width="addWidth">
              <el-input v-model="tempArticle.remark"></el-input>
            </el-form-item>
          </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      getList() {
        //查询列表
        if (!this.hasPerm('attendance:myList')) {
          return
        }
        ...
        this.api({
          url: "/attendance/listMyAttendance",
          method: "post",
      ...
      createArticle() {
        ...
        let  formData={
          ...
          startDate:getHoursTime(this.tempArticle.startDate),
          endDate:getHoursTime(this.tempArticle.endDate),
